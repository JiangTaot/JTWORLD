package com.jsyg.tsyj.controller;
...
public class LoginAuthController {
	...
	// 会话登录接口  ---- http://localhost:18080/acc/doLogin?name=zhang&pwd=123456
	...
	// 查询当前登录状态  ---- http://localhost:18080/acc/isLogin
	...
	// 校验当前登录状态  ---- http://localhost:18080/acc/checkLogin
	...
	// 获取当前登录的账号是谁  ---- http://localhost:18080/acc/getLoginId
	...
	// 查询 Token 信息  ---- http://localhost:18080/acc/tokenInfo
	...
	// 会话注销  ---- http://localhost:18080/acc/logout
