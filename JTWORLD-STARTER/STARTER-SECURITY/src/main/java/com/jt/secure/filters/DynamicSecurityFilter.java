package com.jt.secure.filters;


import com.jt.secure.intercept.DynamicAccessDecisionManager;
import com.jt.secure.intercept.DynamicSecurityMetadataSource;
...
public class DynamicSecurityFilter extends AbstractSecurityInterceptor implements Filter {
    ...
    private SecureIgnoreUrlsYml ignoreUrlsConfig;
    @Autowired
    ...
    @Autowired
    public void setIgnoreUrlsConfig(SecureIgnoreUrlsYml ignoreUrlsConfig) {
